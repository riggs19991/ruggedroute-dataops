...
Generated by `node scripts/make-icons.mjs` and the screenshot harness, in `docs/store/`:
`icon-512.png` (Play icon), `icon-1024.png` (App Store icon), `feature-graphic.png`
(1024×500 Play feature graphic), and phone screenshots `screenshot-home.png`,
`screenshot-category.png`, `screenshot-article.png`, `screenshot-search.png`,
`screenshot-support.png` (1080×1920). Android launcher icons and splash screens are in
`android/app/src/main/res/` from `npx @capacitor/assets generate --android` (sources in `assets/`).
