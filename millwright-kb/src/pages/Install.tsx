  ...
  return (
    <div style={{ maxWidth: 720, display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      <div className="card panel">
        <div className="head"><span className="glyph" aria-hidden="true">📲</span><h2>Android app (APK)</h2></div>
        <ol className="steps">
        ...
        <a className="btn primary" href={APK}>📲 Download the app</a>
      </div>

      <div className="card panel">
        <div className="head"><span className="glyph" aria-hidden="true">📱</span><h2>Add to home screen</h2></div>
        <ol className="steps">
      ...
      <div className="card panel">
        <div className="head"><span className="glyph" aria-hidden="true">👤</span><h2>Sign in, offline, photos</h2></div>
