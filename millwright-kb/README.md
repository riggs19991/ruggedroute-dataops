...
| **Browse** | 26 topic categories: welding and fabrication, cutting and gouging, oxy-fuel, layout and templates, drawings, schematics and P&IDs, alignment, installation and foundations, bearings, belts/chains/couplings, gearboxes, pumps and seals, conveyors, hydraulics and pneumatics, lubrication, vibration and condition monitoring, motors/VFDs/electrical awareness, shop machining, fasteners, rigging, safety, preventive maintenance, troubleshooting, measurement, manufacturer manuals, shop reference. Plus an A-Z index page and a task index article ("Set me up for a task"). |
...
Seed content (201 articles in 26 categories, including practice quizzes and a glossary) is written for the shop bench, imperial first with metric
...
hydraulics (schematics, pump types and testing, directional, pressure and flow valves, stack and
sectional valves, cartridge and logic valves, load-sensing, proportional and servo systems, motors
and hydrostatic drives, fitting identification and thread tables, fluid types and compatibility,
advanced diagnostics), hoses, cylinders, filtration, accumulators and pneumatics; grease and oil
...
Every article carries at least one diagram (286 SVGs under `public/img/`, generated by the
