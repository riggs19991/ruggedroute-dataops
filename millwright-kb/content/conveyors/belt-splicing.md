---
title: "Belt Splicing: Squaring the Belt Ends (Centreline Method), Cutting, Mechanical Fasteners (Hinged, Solid Plate, Rivet, Alligator Lacing) Selection by Belt Thickness and Pulley Diameter, Installing Hinged and Plate Fasteners, Skiving, Vulcanized Splices (Hot and Cold, Step Splice, Bias), Splice Inspection and Records"
slug: belt-splicing
category: conveyors
kind: procedure
manufacturer: Flexco (generic)
model_numbers: ["Flexco Bolt Hinged", "Flexco Bolt Solid Plate", "Flexco Rivet Solid Plate BR", "Alligator RS", "Alligator Ready Set", "Flexco Roller Lacer", "Mato", "Minet"]
tags: [belt splice, belt splicing, mechanical fastener, belt lacing, Alligator lacing, hinged fastener, solid plate fastener, rivet fastener, Flexco, squaring belt ends, belt centerline, cutting belt, skiving belt, vulcanized splice, hot vulcanizing, cold vulcanizing, step splice, bias angle, splice length, splice inspection, belt repair, conveyor belt replacement, pulley diameter fastener, belt thickness fastener, hinge pin]
source: "Flexco fastener selection guidance (belt thickness, minimum pulley diameter and belt tension rating for hinged, solid plate and rivet fasteners) and installation instructions; Fenner Dunlop Conveyor Handbook (squaring, vulcanized splice design: step splice length and bias); Continental ContiTech splicing manual; CEMA belt splicing practice."
summary: "A splice is only as good as the square cut behind it: this covers finding the belt's true centreline and squaring the ends, choosing a mechanical fastener by belt thickness, tension and the smallest pulley, installing hinged and solid-plate fasteners properly (including skiving the covers), the basics of hot and cold vulcanized step splices with the bias and step lengths, and inspecting splices so they are replaced before they fail."
---
...
- [Layout tools and scribing (squaring)](/article/layout-tools-and-scribing)
