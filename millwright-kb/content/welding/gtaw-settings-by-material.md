---
title: "TIG Settings by Material and Thickness: Amperage, Tungsten, Filler, Cup and Gas Flow for Steel, Stainless, Aluminium, Copper, Titanium and Chrome-Moly"
slug: gtaw-settings-by-material
category: welding
kind: chart
tags: [TIG amperage chart, TIG settings, TIG aluminum settings, TIG stainless settings, tungsten size chart, filler rod size, cup size, gas flow, DCEN amps, AC amps, titanium purge, chrome moly, copper TIG, TIG thickness chart]
source: "Miller TIG weld-setting calculator; welders-supply.com TIG settings chart; AWS C5.5; CK Worldwide reference; ESAB and Lincoln TIG guides."
summary: "Starting-point tables for the TIG welder: for each material and thickness the amperage range, tungsten diameter, filler diameter, cup size and argon flow, with the current type, the filler to use, and the material-specific rules (cleaning, purge, preheat, colour) that decide whether the weld is sound."
---
