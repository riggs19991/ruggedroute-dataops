---
title: "Millwright Glossary A to Z: One-Line Definitions of the Trade Terms Used in This Knowledge Base, from Adapter Sleeve and Angularity to Wire Rope Lay and Yield Strength"
slug: millwright-glossary
category: study
kind: reference
tags: [glossary, definitions, millwright terms, trade terminology, what does mean, dictionary, terms, vocabulary, Red Seal terms, apprenticeship terms, study, jargon]
source: "Definitions written against the articles in this knowledge base and standard references (SKF bearing handbook, Machinery's Handbook, AWS A3.0 welding terms and definitions, ASME B30 rigging standards, Hydraulic Institute pump terms)."
summary: "An A to Z glossary of the words a millwright meets on drawings, in catalogues, in manuals and on the floor: bearings, alignment, welding, cutting, hydraulics, lubrication, rigging, pumps, conveyors, motors and measurement. One line each, in plain language, so you can look a term up fast and then search the knowledge base for the full article."
---

Search this page with your browser's find function, or use the app search box with the term; most entries have a full article behind them.
