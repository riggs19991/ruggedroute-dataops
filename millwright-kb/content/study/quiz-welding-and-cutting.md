---
title: "Test Yourself: Welding and Cutting (20 Questions with Answers on SMAW, GMAW, FCAW, GTAW, Oxy-Fuel, Plasma and Carbon Arc Gouging)"
slug: quiz-welding-and-cutting
category: study
kind: reference
tags: [quiz, practice questions, welding quiz, welding test, cutting quiz, Red Seal practice, apprenticeship exam, SMAW questions, GMAW questions, FCAW questions, TIG questions, oxy fuel questions, plasma cutting questions, self test, study questions]
source: "Questions written against the welding and cutting articles in this knowledge base (Lincoln, Hobart, ESAB and Victor process data; AWS A5 filler classifications; CSA W59 and AWS D1.1 conventions)."
summary: "Twenty practice questions on the welding and cutting material in this knowledge base, from electrode classification and polarity to oxy-fuel pressures and plasma cut quality. Try each one before opening the answer. Each answer names the article to review if you got it wrong."
---

How to use this: read the question, decide on your answer, then tap **Answer**. Score yourself out of 20. Anything under 16 means read the linked articles again before the exam.
