---
title: "Coupling Installation by Type: Grid (Falk Steelflex T10/T20) Gap, Grid and Grease, Gear Couplings (Lubrication and Fill), Disc Couplings (DBSE and Bolt Torque), Elastomeric Jaw, Tire and Sleeve Couplings, Hub Mounting, Coupling Guards, Misalignment Limits and Regreasing"
slug: grid-gear-and-disc-coupling-installation
category: power-transmission
kind: procedure
manufacturer: Rexnord Falk / Lovejoy / Dodge / Kop-Flex (generic)
model_numbers: ["Falk Steelflex T10", "Falk Steelflex T20", "1050T", "1060T", "1070T", "Falk Lifelign", "Kop-Flex Series H", "Thomas disc coupling", "Rexnord Omega", "Lovejoy L-Jaw", "Dodge Para-Flex", "Sure-Flex"]
tags: [coupling installation, grid coupling, Steelflex, Falk T10, coupling gap, grid spring, coupling grease, gear coupling, gear coupling grease, gear coupling lubrication, disc coupling, DBSE, spacer coupling, coupling bolt torque, jaw coupling, spider, tire coupling, Para-Flex, Omega coupling, Sure-Flex, coupling hub mounting, coupling misalignment limits, coupling guard, coupling regrease, coupling failure]
source: "Rexnord Falk Steelflex T10 installation manual 428-110 (gap, grid installation, lubrication quantities, cover fastener torque); Falk Lifelign gear coupling manual; Rexnord/Thomas disc coupling manuals (DBSE and bolt torque practice); Lovejoy L/C-Jaw and Dodge Para-Flex installation sheets; Piotrowski, Shaft Alignment Handbook (coupling tolerances)."
summary: "Each coupling type has its own installation rules that alignment alone does not cover: the grid coupling's hub gap, grid direction and grease charge; the gear coupling's fill and the reasons it fails; the disc coupling's DBSE and its bolts; the elastomeric couplings' element and gap; plus how to mount the hubs, what misalignment each type tolerates, the guard, and the regreasing routine for the lubricated ones."
---
