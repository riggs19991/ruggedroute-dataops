---
title: "Layout Tools and Scribing: Layout Dye, Scribers, Punches, Dividers and Trammels, Combination and Framing Squares, Surface Gauge, Wrap-Arounds and Contour Markers, Finding Centres, Squaring with 3-4-5 and Diagonals, Working from a Datum, Witness Marks"
slug: layout-tools-and-scribing
category: layout-templates
kind: procedure
tags: [layout, layout tools, layout dye, Dykem, scriber, center punch, prick punch, dividers, trammel points, trammel, combination square, center head, protractor head, framing square, surface gauge, height gauge, V block, wrap around, contour marker, Curv-O-Mark, center finder, 3-4-5 rule, diagonals square, datum edge, witness marks, soapstone, silver pencil, chalk line, plumb bob, scribing a line, laying out a plate, keyway layout]
source: "General trade practice as taught in millwright and pipe-trades programs (BC ITA Millwright Manual, NCCER); Starrett tool instructions (combination square set, surface gauge, trammels); Flange Wizard / Jackson Curv-O-Mark instructions; Machinery's Handbook layout section."
summary: "The layout kit a millwright or fabricator carries and how each tool is used correctly, how to prepare a surface and scribe lines that survive cutting, the punch marks that let you find a line after the dye is gone, finding centres of round and flat stock, squaring by 3-4-5 and equal diagonals, laying out from one datum so errors do not accumulate, and marking pipe with wrap-arounds and contour markers."
---
...
- [Reading a micrometer](/article/reading-a-micrometer) and [dial indicator use](/article/dial-indicator-use)
