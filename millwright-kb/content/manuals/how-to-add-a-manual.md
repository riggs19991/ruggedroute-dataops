---
title: "How to Add a Manufacturer Manual or Datasheet to This Library"
slug: how-to-add-a-manual
category: manuals
kind: tip
tags: [upload, manual, PDF, contribute, Dodge, Baldor, SKF, Timken, Falk, Rexnord, Gates, datasheet, how to use this app]
source: "This app."
summary: "Anyone signed in can upload a gearbox, motor, pump, coupling or bearing manual. This tip explains what to fill in so other students can find it by manufacturer, model number and topic."
---

Found a Dodge gearbox with no manual in the library? Got a PDF from the maker's website or a scan from the crib? Add it.
