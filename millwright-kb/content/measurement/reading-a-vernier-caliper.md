---
title: "Reading a Vernier, Dial and Digital Caliper: Inch and Metric Scales, the Four Measurements, Accuracy Limits and the Checks Before You Trust It"
slug: reading-a-vernier-caliper
category: measurement
kind: procedure
tags: [caliper, vernier caliper, dial caliper, digital caliper, reading a vernier, 0.001 in, 0.02 mm, outside measurement, inside measurement, depth, step, caliper accuracy, zeroing a caliper, Abbe error]
source: "Mitutoyo and Starrett caliper instructions; Machinery's Handbook (measuring instruments); ASME B89.1.14 (calipers)."
summary: "How to read the three caliper types in inch and metric, take outside, inside, depth and step measurements correctly, what accuracy to expect (about 0.001 in, never a micrometer substitute), and the zero, jaw and squareness checks that catch a bad reading before it becomes a bad part."
---

> A caliper reads to 0.001 in (0.02 mm) but is only trustworthy to about **0.002 in** on a good day: the jaws flex, the work tilts and the beam wears. Use it to get close and to measure inside, depth and step; use a [micrometer](/article/reading-a-micrometer) when a fit depends on the last thousandth.
...
- [Shop reference tables: decimal equivalents](/article/shop-reference-tables)
