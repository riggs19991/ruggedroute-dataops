---
title: "Telescoping Gauges, Small-Hole Gauges, Dial Bore Gauges and Inside Micrometers: Measuring a Bore Correctly for a Bearing or Bushing Fit"
slug: telescoping-and-bore-gauges
category: measurement
kind: procedure
tags: [telescoping gauge, snap gauge, T-gauge, small hole gauge, ball gauge, dial bore gauge, inside micrometer, measuring a bore, bore diameter, housing bore, bushing bore, out of round, taper, bell mouth, bore gauge setting ring]
source: "Starrett and Mitutoyo instructions for telescoping, small-hole and dial bore gauges; Machinery's Handbook; SKF housing bore tolerance guidance."
summary: "Which bore gauge to use for which size and accuracy, the rocking technique that makes a telescoping gauge read true, how to zero and read a dial bore gauge against a micrometer or setting ring, measuring at several depths and angles to find taper and out-of-round, and the housing bore numbers a bearing fit needs."
---

> A bore is never measured once. Measure at **two angles (90° apart) and three depths**: the spread between readings is the out-of-round and the taper, and it decides whether the housing or bushing is any good before the diameter does.
