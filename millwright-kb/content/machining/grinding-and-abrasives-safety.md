---
title: "Grinding and Abrasives Safety: Bench and Pedestal Grinder Rules (Tool Rest 1/8\", Tongue Guard 1/4\", Ring Test, Wheel Speed, Dressing), Angle Grinder and Die Grinder Rules, Wheel Selection for Tool Sharpening (Aluminium Oxide, Silicon Carbide, CBN, Diamond), Sharpening Drills, Lathe Bits, Chisels and Punches, Belt Grinders and Sanders, Dust, Sparks and Fire, Face Shields and Hearing"
slug: grinding-and-abrasives-safety
category: machining
kind: safety
tags: [grinding safety, bench grinder safety, pedestal grinder, tool rest 1/8, tongue guard 1/4, ring test, wheel speed rating, wheel bursting, wheel dressing, star dresser, diamond dresser, angle grinder safety, die grinder safety, mounted point speed, grinding wheel selection, aluminum oxide wheel, silicon carbide wheel, CBN wheel, diamond wheel, sharpening drill bits, sharpening lathe tools, sharpening chisels, mushroomed chisel, belt grinder, sander safety, grinding dust, magnesium dust, grinding sparks fire, face shield grinding, OSHA 1910.215, OSHA 1910.243, ANSI B7.1]
source: "OSHA 29 CFR 1910.215 (abrasive wheel machinery) and 1910.243 (portable powered tools); ANSI B7.1 Safety Requirements for the Use, Care and Protection of Abrasive Wheels; Norton and Camel Grinding Wheels safety and selection guides; grinder manufacturer manuals (Baldor, DeWalt, Metabo); NFPA 484 (combustible metals)."
summary: "The grinder is the shop's most-used and most-abused machine: this covers the OSHA and ANSI rules for bench and pedestal grinders and why each exists (the tool rest and tongue guard distances, the ring test, speed ratings, flanges and blotters, dressing), the portable grinder and die grinder rules, which wheel for which job when sharpening tools, the technique for drills, lathe bits, chisels and punches, belt grinders, the dusts and sparks that start fires and hurt lungs, and the PPE."
---

## Why grinders hurt people
...
- [Welding safety (hot work)](/article/welding-safety-fumes-and-ppe)
