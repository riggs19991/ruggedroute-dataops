---
title: "Drill Press Speeds and Feeds: The RPM Formula, SFM by Material for HSS and Cobalt Drills, RPM Tables for Common Drill Sizes, Feed per Revolution, Drill Point Angles and Sharpening by Hand, Pilot Drills and Web Thickness, Countersinks, Counterbores and Reamers, Coolant and Lubricant, Work Holding and Drill Press Safety, Troubleshooting Drill Problems"
slug: drill-press-speeds-and-feeds
category: machining
kind: chart
tags: [drill press, drill speed, drill rpm, rpm formula, SFM, surface feet per minute, cutting speed, drill speed chart, drill feed, feed per revolution, drilling steel, drilling stainless, drilling aluminum, drilling cast iron, HSS drill, cobalt drill, carbide drill, drill point angle, 118 degree, 135 degree split point, sharpening a drill, drill grinding, pilot hole, web thickness, countersink, counterbore, reamer speed, cutting oil, tapping fluid, drill press vise, drill press safety, drill walks, drill squeals, drill breaks]
source: "Machinery's Handbook (drilling speeds and feeds tables by material and tool material; drill point geometry); drill manufacturer speed charts (Cleveland/Greenfield, Dormer, Precision Twist Drill); Norseman/Viking drill guidance; OSHA 1910.212 and drill press manufacturer manuals (guarding and work holding)."
summary: "Everything for making a good hole on the drill press: the formula and the surface-speed table that give the spindle rpm for any drill in any material, a ready rpm chart, how much to feed, drill point angles and how to sharpen a drill by hand so it cuts, when to pilot and how big, the follow-up tools (countersink, counterbore, reamer) and their speeds, what coolant to use, how to hold the work so it does not spin, and the fixes for a drill that walks, squeals, chips or breaks."
---
