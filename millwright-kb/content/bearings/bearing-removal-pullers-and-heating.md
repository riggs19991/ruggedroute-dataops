---
title: "Bearing Removal: Puller Selection (Jaw, Push-Puller, Blind-Hole, Hydraulic), Pulling on the Right Ring, Heating a Ring to Remove It, Induction Removal, Cutting Off a Seized Inner Ring, Withdrawal Sleeves and Hydraulic Nuts, Preserving the Evidence"
slug: bearing-removal-pullers-and-heating
category: bearings
kind: procedure
manufacturer: "SKF / Posi Lock / Enerpac (generic)"
model_numbers: ["SKF TMMA", "SKF TMHP", "SKF TMBP", "Posi Lock 104", "Posi Lock 106", "Enerpac Sync-Grip", "OTC 1179", "SKF TMMD"]
tags: [bearing removal, bearing puller, jaw puller, three jaw puller, two jaw puller, push puller, bearing separator, blind hole puller, slide hammer, hydraulic puller, pulling a bearing, heating a bearing to remove, induction heater removal, cutting a bearing off, seized inner ring, withdrawal sleeve, hydraulic nut, oil injection, puller safety, bearing failure evidence]
source: "SKF Bearing Maintenance Handbook (dismounting chapter: puller types, heating rings, oil injection, withdrawal sleeves); Timken bearing handling guidance; Posi Lock and Enerpac puller selection and safety guidance; SKF/Timken failure-analysis guidance on preserving failed bearings."
summary: "How to get a bearing off a shaft or out of a housing without damaging the shaft, the housing, or yourself: choosing a puller by the type of grip and the force needed, always pulling on the ring with the interference fit, heating a stuck inner ring quickly with a torch or an induction ring, the cut-and-crack method for a welded-on ring, dismounting adapter and withdrawal-sleeve bearings including hydraulic nuts and oil injection, and how to keep the failed bearing as evidence."
---

> A puller under load is a spring. Never stand in line with the shaft or the puller screw, never extend the handle with a pipe, wear a face shield, and stop when the puller jaws start to slip or bend: the bearing is about to explode off or the puller is about to let go.
