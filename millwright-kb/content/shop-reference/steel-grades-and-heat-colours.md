---
title: "Steel and Metal Grades for Millwrights: AISI/SAE Carbon and Alloy Steels, Structural Grades, Tool Steels, Stainless, Aluminium, Bronze and Cast Irons, Plus Temper and Incandescent Heat Colour Charts and Basic Heat Treating"
slug: steel-grades-and-heat-colours
category: shop-reference
kind: chart
tags: [steel grades, 1018, 1045, 4140, 4340, 8620, 1095, A36, A572, A500, A513, 12L14, O1, A2, D2, S7, H13, 304, 316, 410, 17-4, 6061, 5052, 7075, 932 bronze, 954 bronze, grey iron, ductile iron, temper colour chart, heat colour chart, cherry red temperature, hardening, tempering, annealing, quench, normalizing, case hardening, shaft material, keystock material]
source: "ASM Metals Handbook and ASM Heat Treater's Guide; SAE J403/J404 (steel grades); ASTM A36, A572, A500, A513, A108, A29; AISI tool steel classifications; Aluminum Association alloy data; CDA bronze data; Machinery's Handbook (temper colours and heat colour tables)."
summary: "The grades a millwright meets in bar racks, shafts, keys, sprockets, tool steel and repairs, with what each is for, its typical strength and hardness, how it machines, welds and hardens, then the temper colour chart (400-640°F), the incandescent heat colour chart (900-2,400°F) and the basic hardening, tempering, annealing and normalising rules for the common grades."
---

> The number tells you the chemistry. In the AISI/SAE system the **last two digits are carbon in hundredths of a percent** (1045 = 0.45% C) and the **first two are the alloy family** (10xx plain carbon, 11xx resulphurised free-machining, 12xx free-machining with lead/phosphorus, 41xx chrome-moly, 43xx nickel-chrome-moly, 86xx nickel-chrome-moly low alloy, 51xx/52xx chromium, 92xx silicon-manganese spring). Carbon above about 0.30% means the steel **hardens** when quenched from red, which is why welding and torch-heating 1045 and 4140 need care.
