---
title: "Pipe Schedule, Weight and Flange Tables: ASME B36.10 NPS Dimensions (Sch 10 to XXS), Weight per Foot, ASME B16.5 Class 150 and 300 Flange Bolt Patterns, Pressure Ratings and NPT Thread Data"
slug: pipe-schedule-and-flange-tables
category: shop-reference
kind: chart
tags: [pipe schedule chart, schedule 40, schedule 80, pipe OD, NPS, nominal pipe size, pipe wall thickness, pipe weight per foot, flange bolt pattern, class 150 flange, class 300 flange, bolt circle, flange bolt size, ASME B16.5, raised face, flange pressure rating, NPT threads per inch, NPT tap drill, pipe thread engagement, pipe ID, water in pipe]
source: "ASME B36.10M (welded and seamless wrought steel pipe) and B36.19M (stainless); ASME B16.5-2020 (pipe flanges and flanged fittings, Class 150/300 dimensions and pressure-temperature ratings for Group 1.1 A105/A106 materials); ASME B1.20.1 (NPT threads); Machinery's Handbook."
summary: "The pipe and flange numbers every millwright and pipefitter needs at the bench: NPS outside diameters and wall thickness by schedule, weight per foot and water weight, Class 150 and 300 flange OD, bolt circle, bolt count and bolt size, the raised-face and pressure-temperature basics, NPT threads per inch, tap drills and the hand-tight plus wrench-turn rule."
---

> **NPS is a name, not a dimension.** A 2 in pipe is 2.375 in OD in every schedule; the schedule changes the **wall** and therefore the ID. Above NPS 12 the OD equals the NPS. Tube is the opposite: named by its OD. Hydraulic and instrument tubing tables are in [hydraulic hose and fittings](/article/hydraulic-hose-assembly-and-fittings).
